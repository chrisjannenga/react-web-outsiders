...
class ShopperThreeEditProfile extends React.Component {
  state = {
    shopper: []
  }

  componentWillMount() {
    axios.get('http://localhost:8000/shoppers/3.json').then(response => this.setState({shopper: response.data}))
  }
        ...
        <div className="container">
          <div className="section">
            ...
            <div className='row center'>
              ...
              <a href="/shopper/3" className="btn waves-effect waves-light orange ">Update</a>
            </div>
            </div>
            </div>
                </div>
...
export default ShopperThreeEditProfile
