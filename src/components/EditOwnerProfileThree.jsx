...
class EditOwnerProfileThree extends React.Component {
  state = {
    Owner: []
  }
        ...
        <div className="container">
          <div className="section">
            ...
            <div className='row center'>
              ...
              <a href="/owner/3" className="btn waves-effect waves-light orange ">Update</a>
            </div>
            </div>
            </div>
                </div>
...
export default EditOwnerProfileThree
