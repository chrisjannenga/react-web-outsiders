...
class OwnerOneDashboard extends React.Component {
  state = {
    Owner: []
  }
            ...
            <div className="container">
              ...
              <div className="row center">
                <div className="col s2 offset-s5">
                  <img src="https://pbs.twimg.com/profile_images/877338248476901376/oPxE6ucR.jpg" alt="" className="circle responsive-img whiteBorder z-depth-5"/>
                </div>
              ...
              <div className="section">
                ...
                <div className="row center">
                    <div className="col s12 m6 offset-m3 white-text">
...
export default OwnerOneDashboard
