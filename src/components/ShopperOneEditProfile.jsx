...
class ShopperOneEditProfile extends React.Component {
  state = {
    shopper: []
  }
        ...
        <div className="container">
          <div className="section">
            ...
            <div className='row center'>
              ...
              <a href="/shopper/1" className="btn waves-effect waves-light orange ">Update</a>
            </div>
            </div>
            </div>
                </div>
...
export default ShopperOneEditProfile
