...
class OwnerOneSurveyView extends React.Component {
  state = {
    survey: [],
    owner: []
  }
            ...
            <div className="section">
              <div className="card-panel grey darken-3 z-depth-5">
                ...
                <div className='row center top-pad'>
                  ...
                  <a href="/owner/1" className="btn-large waves-effect waves-light orange ">Back to Dashboard</a>
                </div>
                </div>
              </div>
            </div>
...
export default OwnerOneSurveyView
