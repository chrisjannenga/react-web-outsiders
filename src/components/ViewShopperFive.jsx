...
class ViewShopperFive extends React.Component {
      state = {
        Shopper: []
      }

      componentWillMount() {
        axios.get('http://localhost:8000/shoppers/5.json').then(response => this.setState({Shopper: response.data}))
      }
...
export default ViewShopperFive
