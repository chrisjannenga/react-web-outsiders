...
class OwnerThreeDashboard extends React.Component {
                      ...
                      <div className="container">
                        ...
                        <div className="row center">
                          <div className="col s2 offset-s5">
                            <img src="http://groffteam.com/users//u4/4134/Nikki-Groff-bw_300x300.jpg" alt="" className="circle responsive-img whiteBorder z-depth-5"/>
                          </div>
                    ...
                    <div className="container">
                      <div className="section">
                        ...
                        <div className="row">
                          ...
                          <div className="col s12 m4">
                            <a href="/editOwnerProfile/owner/3">
                            <div className="icon-block">
                              <h2 className="center orange-text">
...
export default OwnerThreeDashboard
