...
class ViewShopperEight extends React.Component {
      state = {
        Shopper: []
      }

      componentWillMount() {
        axios.get('http://localhost:8000/shoppers/8.json').then(response => this.setState({Shopper: response.data}))
      }
...
export default ViewShopperEight
