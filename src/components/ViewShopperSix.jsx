...
class ViewShopperSix extends React.Component {
      state = {
        Shopper: []
      }

      componentWillMount() {
        axios.get('http://localhost:8000/shoppers/6.json').then(response => this.setState({Shopper: response.data}))
      }
